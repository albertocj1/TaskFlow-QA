...
- Name: tasks.spec.ts >> Task Tracker - core workflow >> toggles a task as completed
- Location: tests\tasks.spec.ts:14:7
...
- generic [ref=e2]:
  ...
  - main [ref=e6]:
    ...
    - list [ref=e14]:
      ...
      - listitem [ref=e19]:
        - generic [ref=e20]:
          - checkbox "Task A" [ref=e21]
          - text: Task A
        - text: low
        - button "Delete" [ref=e22]
      - listitem [ref=e23]:
        - generic [ref=e24]:
          - checkbox "Review PR" [checked] [active] [ref=e25]
          - text: Review PR
        - text: medium
